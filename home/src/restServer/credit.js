...
import {townURL} from '@/config/constant'
import axios from 'axios';
let loanCreditServer = server('http://182.140.213.68:9080/zhixin/:params1/:params2/:params3/:params4/:params5',{},{
...
},axios.create({baseURL:townURL}));
export default loanCreditServer;
