  ...
  <div class="Coordinate">
    ...
    <Row style="margin-bottom: 15px;">
      ...
      <Row type="flex" justify="end" :gutter="16">
        <Col>
        <Button type="info" icon="plus-round" @click="add()">添加联席会议</Button>
        </Col>
      </Row>
      </Col>
    </Row>
  ...
  export default {
                ...
                h('Button', {
                  ...
                  on: {
                    click: () => {
                      this.$router.push({
                        name: 'coordinateUser',
                        params: {orgId: params.row.id, orgName: params.row.name, orgType: params.row.orgSubtype,userType:204}
                      })
                    }
                  }
                }, '查看用户'),
    ...
    methods: {
      ...
      getTableData (){
        this.tableData = [];
        this.loading = true;
        this.$router.push('coordinate?current=' + this.current + "&pageSize=" + this.pageSize + "&name=" + this.name
      ...
      add(data){
        ...
        this.$router.push({name: "coordinateAdd"})
      },
      editInit(data){
        ...
        this.formCustom = {
          ...
          Coordinate_id: data.location.Coordinate_id,
