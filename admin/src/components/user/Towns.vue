  ...
  <div class="Village">
    ...
    <Row style="margin-bottom: 15px;">
      ...
      <Row type="flex" justify="end" :gutter="16">
        <Col>
        <Button type="info" icon="plus-round" @click="add()">添加乡镇机构</Button>
        </Col>
      </Row>
      </Col>
    </Row>
  ...
  export default {
    ...
    methods: {
      ...
      getTableData (){
        this.tableData = [];
        this.loading = true;
        this.$router.push('towns?current=' + this.current + "&pageSize=" + this.pageSize + "&name=" + this.name
      ...
      add(data){
        ...
        this.$router.push({name: "townsAdd"})
      },
      editInit(data){
