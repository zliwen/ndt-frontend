    ...
    <div class="contentBox">
      <Form ref="formOrgItem" :model="formOrgItem" :rules="ruleCustom" :label-width="120">
        ...
        <FormItem label="机构所在区域：" prop="adminDivisionId">
          <GetCity :changeOnSelect="changeOnSelect"  :set-value="formOrgItem.adminDivisionId" @onChange="adminDivisionIdChange"></GetCity>
        </FormItem>
        <FormItem label="机构管辖范围：" prop="divisions">
          <GetCity :changeOnSelect="changeOnSelect" :set-value="formOrgItem.divisions" @onChange="divisionsChange"></GetCity>
        </FormItem>
        <FormItem>
