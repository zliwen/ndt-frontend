        ...
        <div  class="edit-eara" style="width:910px; margin: 0 auto">
            <Form  v-show="true" ref="formData" :model="formData" inline label-position="right" :rules="ruleCustom">
                    ...
                    <!-- <FormItem required label="覆盖地区" :label-width='80' >
                        <GetCity ref='getCity' :disabled='readOnly' style="width:200px;" :setValue="initValue" @onChange="adminDivisionIdChange"></GetCity>
                    </FormItem> -->
                ...
                this.$refs.formData.validate((valid) => {
                     if (valid) {
                        ...
                        if(this.modalType == 'new'){//新增
                            ...
                            ,Object.assign({},this.formData,{content,importance,state,type:6502})
                            , function (response) {
                                if(response.errorCode == 0){
                                    that.$Message.success("新增成功");
                                    that.$router.push('../ndt-policy');
                                }
