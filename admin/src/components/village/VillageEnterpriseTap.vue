...
*/
<template>
  <div class="VillageEnterpriseTap">
  ...
  export default {
    ...
    methods: {
      ...
      getTableData (){
        this.tableData = [];
        this.loading = true;
        this.$router.push('village-enterprise-tap?current=' + this.current + "&pageSize=" + this.pageSize + "&name=" +
          this.name);
      ...
      add(data){
        ...
        this.$router.push({name: "VillageEnterpriseTapAdd"})
      }
    }
  }
</script>
